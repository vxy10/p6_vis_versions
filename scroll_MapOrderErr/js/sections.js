...
var path = d3.geo.path()
  ...
  setupVis = function(overall_sentiment,overall_sentimentairline,
                      overall_reason,overall_reasonairline,overall_LatLong,overall_LatLongAirport) {
   ...
   // figure 8: MAP ADDED
    draw_US_Map_airports(overall_LatLongAirport,"fig8");
...
/*
  var legendF2 = g.selectAll(".legend2")
      .data(colorStackedBar.domain().slice())
    .enter().append("g")
      .attr("class", "legend2 fig5 legend")
      .attr("transform", function(d, i) { return "translate(" + (180+i*200) + "," + 500 + ")"; });
...
/*
  var legendF2 = g.selectAll(".legend2")
      .data(colorStackedBar.domain().slice())
    .enter().append("g")
      .attr("class", "legend2 fig6 legend")
      .attr("transform", function(d, i) { return "translate(" + (180+i*200) + "," + 500 + ")"; });
...
class_names_f = "feature " + fig_name;
 class_names_m = "mesh " + fig_name;
 class_names_l = "land " + fig_name;
...
function draw_US_Map_airports(overall_LatLongAirport,fig_name){
class_names_f = "feature map_USA fig_name";
 class_names_m = "mesh map_USA fig_name" ;
 class_names_l = "land map_USA fig_name" ;
  ...
  var color_names = {"negative":"red",
    ...
    var circles_ap = g.selectAll('circle')
              .data(overall_LatLongAirport,function (d,i) {return d})
              .append("circle")
              .attr("class", fig_name)
              ...
              .attr("opacity",1); //console.log(d.key,d.values[x].key,d.values[x].values)

}  



function draw_US_Map_airports22(overall_LatLongAirport,fig_name){
  debugger
    //draw_US_Map(fig_name);
...
function get_data_airport() {
  d3.csv("data/data_airports.csv", function(d) {
  return {
    airport_name: d.airport_name, // convert "Year" column to Date
    airport_lat: +d.latitude,
    airport_lon: +d.latitude
  };
