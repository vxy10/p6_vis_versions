...
function draw_US_Map_airports(overall_LatLongAirport,fig_name){
 ...
 class_names_l = "land " + fig_name;
  ...
  circles_ap.enter()
          ...
          .duration(200)
          .attr("class", fig_name)
          .attr('r', function (d) {return d.total/20})
          .attr("transform", function(d) {
                return "translate(" + projection([d.lon,d.lat]) + ")";
              })
          .attr("opacity",1);
  ...
  function groupByCount_LatLongAirport(data) {
    ...
    data = d3.nest()
      ...
      data.map(function(d,i) {
          ...
          for (x in d.values) { console.log(d.key,d.values[x].key,d.values[x].values)
