...
debugger;  
 ...
 var places = [
  ...
  var chart = function(selection) {
    selection.each(function(rawData) {
     ...
     draw_US_Map(overall_LatLong);
      ...
      setupVis(overall_sentiment,overall_sentimentairline,overall_reason,overall_reasonairline);
   ...
   */
  setupVis = function(overall_sentiment,overall_sentimentairline,overall_reason,overall_reasonairline) {
...
function draw_US_Map(overall_LatLong){
          "use strict";
...
d3.csv("data/data_twitter.csv", function(d) {
  return {
    ...
    lat: +d.latitude,
    lon: +d.longitude,
    timezone: d.user_timezone// convert "Length" column to number
  };
},display);
