  ...
  /*g.append("path")
   ...
   overall_LatLongAirport.forEach(function (d,i) {
    ...
    overall_LatLongAirport.forEach(function (d,i) {
            //console.log(d)
             g.append("circle")
              .attr("class", fig_name + " negative-circle")
              .attr('r', Math.sqrt(4*d.negative))
              .attr("transform", "translate(" + projection([d.lon,d.lat]) + ")")
              .attr("opacity",0);});   
    ...
    overall_LatLongAirport.forEach(function (d,i) {
            //console.log(d)
             g.append("circle")
              .attr("class", fig_name + " positive-circle")
              .attr('r', Math.sqrt(4*d.positive))
              .attr("transform", "translate(" + projection([d.lon,d.lat]) + ")")
              .attr("opacity",0);});   
    overall_LatLongAirport.forEach(function (d,i) {
            //console.log(d)
             g.append("circle")
              .attr("class", fig_name + " neutral-circle")
              .attr('r', Math.sqrt(4*d.positive))
              .attr("transform", "translate(" + projection([d.lon,d.lat]) + ")")
              .attr("opacity",0);});   
